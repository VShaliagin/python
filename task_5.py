...
class Pen(Stationery):
    ...
    def draw(self):
        return(f'Запуск режима рисования ручка {self.title}.')
...
class Pencil(Stationery):
    ...
    def draw(self):
        return(f'Запуск режима рисования карандаш {self.title}.')
...
class Handle(Stationery):
    ...
    def draw(self):
        return(f'Запуск режима рисования маркер {self.title}.')
